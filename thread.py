...
def classification():
	...
	#BLUE VAR------------------------
	addr = "AC:EE:9E:03:0D:82"
	uuid = "00001101-0000-1000-8000-00805F9B3520"
	data = ''
	...
	bt_port = first_match["port"]
	bt_name = first_match["name"]
	bt_host = first_match["host"]
		
	print "connecting to \"%s\" on %s" % (bt_name, bt_host)
